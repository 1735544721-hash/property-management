...
public class PetService {
     ...
     * 分页查询宠物列表
     */
    public Page<Pet> getPetsByPage(String name, String adoptionStatus, Long categoryId, Integer currentPage, Integer size) {
    ...
    private void collectChildCategoryIds(Long parentId, List<Long> categoryIds) {
        List<PetCategory> children = petCategoryService.getChildCategories(parentId);
