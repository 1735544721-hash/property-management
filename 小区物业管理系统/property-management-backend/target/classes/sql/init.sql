...
('admin', '$2a$10$s1gHkZVSAhdNVq68psTMf.Fm1aHW1HeLh/ky2EZBXS36xTHjn5A0i', '系统管理员', '13800000000', 'admin', 1);

-- 初始化物业员工账号
INSERT INTO sys_user (username, password, real_name, phone, role, status) VALUES 
('staff01', '$2a$10$s1gHkZVSAhdNVq68psTMf.Fm1aHW1HeLh/ky2EZBXS36xTHjn5A0i', '张物业', '13800000001', 'staff', 1);

-- 初始化业主账号
INSERT INTO sys_user (username, password, real_name, phone, role, status) VALUES 
('user01', '$2a$10$s1gHkZVSAhdNVq68psTMf.Fm1aHW1HeLh/ky2EZBXS36xTHjn5A0i', '李业主', '13800000002', 'resident', 1),
('user02', '$2a$10$s1gHkZVSAhdNVq68psTMf.Fm1aHW1HeLh/ky2EZBXS36xTHjn5A0i', '王业主', '13800000003', 'resident', 1);
